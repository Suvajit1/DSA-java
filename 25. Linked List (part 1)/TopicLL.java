public class TopicLL {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(ll.searchRecursive(3,ll.head,0));
        System.out.println(ll.searchRecursive(8,ll.head,0));
        ...
        ll.printElement();
        System.out.println(ll.removeFromLastIndex(ll.size));
        ll.printElement();
        System.out.println(ll.removeFromLastIndex(10));
        ll.printElement();

        System.out.println(ll.isPallindram());
        ...
        System.out.println(ll2.isPallindram());
    }
}
